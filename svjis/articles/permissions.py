...
svjis_view_fault_menu = "articles.svjis_view_fault_menu"  # Can view Faults menu
svjis_fault_reporter = "articles.svjis_fault_reporter"  # Can report fault
svjis_fault_resolver = "articles.svjis_fault_resolver"  # Can resolve fault
svjis_add_fault_comment = "articles.svjis_add_fault_comment"  # Can add Fault comment
